...
const PaymentModal = ({
  ...
  const fetchMobileNumbers = async () => {
    try {
      const response = await axios.get(
        "https://backdeploy.vercel.app/api/customer/mobile-numbers"
      );
  ...
  //     const customerResponse = await axios.get(`https://backdeploy.vercel.app/api/customer/get-customer-by-mobile/${formData.mobileNumber}`);
  ...
  //         await axios.patch(`https://backdeploy.vercel.app/api/customer/update-credit-balance/${existingCustomer._id}`, {
  ...
  //     const response = await axios.patch(`https://backdeploy.vercel.app/api/order/update-order-by-id/${orderID}`, {
  //       ...formData,
  //       orderID,
  //       orderNumber,
  ...
  //   // Add a new customer
  //   const newCustomerResponse = await axios.post('https://backdeploy.vercel.app/api/customer/customer/list/add-customer', {
  //     customerName: formData.customerName,
  //     mobileNumber: formData.mobileNumber,
    ...
    try {
      ...
      if (formData.mobileNumber) {
        const customerResponse = await axios.get(
          `https://backdeploy.vercel.app/api/customer/get-customer-by-mobile/${formData.mobileNumber}`
        );
        existingCustomer = customerResponse.data;
      }
      ...
      if (formData.mobileNumber && parseFloat(formData.dueAmount) > 0) {
        ...
        if (updatedCreditBalance > 0) {
          await axios.patch(
            `https://backdeploy.vercel.app/api/customer/update-credit-balance/${existingCustomer._id}`,
            {
              creditBalance: updatedCreditBalance,
            }
          );
      ...
      const response = await axios.patch(
        `https://backdeploy.vercel.app/api/order/update-order-by-id/${orderID}`,
        {
          ...formData,
  ...
  const addNewCustomer = async () => {
    ...
    const newCustomerResponse = await axios.post(
      "https://backdeploy.vercel.app/api/customer/customer/list/add-customer",
      {
        customerName: formData.customerName,
        mobileNumber: formData.mobileNumber,
        creditBalance: parseFloat(formData.dueAmount),
  ...
  const fetchCustomerDetails = async (mobileNumber) => {
    try {
      const response = await axios.get(
        `https://backdeploy.vercel.app/api/customer/get-customer-by-mobile/${mobileNumber}`
      );
